...
Leflunomide is currently **not marketed** in Germany under this record (`market_status: Not marketed`), and no authorization entries are available (`total_licenses: 0`). No product/license table can be generated.
