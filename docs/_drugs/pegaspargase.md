...
Pegaspargase currently has **no marketing authorization in Germany** in this dataset (`market_status: Not marketed`, `total_licenses: 0`). No product listings are available to summarize.
