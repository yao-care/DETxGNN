...
Midazolam currently holds **no active marketing authorization** on file in this dataset (`market_status`: Not marketed / Not marketed; `total_licenses`: 0). No product/license records are available to summarize.
