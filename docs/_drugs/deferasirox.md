...
> Deferasirox is an oral iron chelator, clinically established for managing chronic iron overload (e.g., transfusional iron overload).
> The TxGNN model predicts it may be effective for **HIV Infectious Disease**,
> currently supported only by **0 clinical trials** and **2 publications**, both at a preclinical/mechanistic level.
...
|------|-----|------|------|---------|
| [34550543](https://pubmed.ncbi.nlm.nih.gov/34550543/) | 2021 | Mechanistic/In vitro | Journal of NeuroVirology | Endolysosomal iron restriction increases HIV-1 Tat oligomerization and β-catenin expression, thereby suppressing Tat-mediated HIV-1 LTR transactivation; deferasirox itself was not tested |
| [16529348](https://pubmed.ncbi.nlm.nih.gov/16529348/) | 2006 | Review (general new-drug overview, not HIV-specific) | Journal of the American Pharmacists Association | Brief introductory overview of newly approved drugs including deferasirox; no HIV-related content |
