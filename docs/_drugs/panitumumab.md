...
*(Note: `BfArM package insert warnings/contraindications` is flagged as a **Blocking** data gap — DG001. This must be resolved before this candidate can proceed to S1 safety evaluation.)*
