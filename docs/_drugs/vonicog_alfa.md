...
Vonicog alfa is **not currently marketed in Germany** (`market_status: Not marketed`) and has **0 registered authorizations**. No product/license records are available to summarize.
