...
Alglucosidase alfa is currently **not marketed** in Germany under this evidence pack (`market_status: Not marketed`), with **0 registered authorizations**. No license records are available to cite for approved indication text.
