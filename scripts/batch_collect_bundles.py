...
import pandas as pd
from detxgnn.collectors import DrugBundleAggregator
from detxgnn.paths import get_bundles_dir, slugify
...
def preload_predictions(min_score: float = 0.99, top_n: int = 10) -> dict[str, list]:
    ...
    """
    from detxgnn.collectors.drug_bundle import PredictedIndication
    from detxgnn.collectors.known_relations import KnownRelationsChecker
...
def patch_single_drug(
    ...
    """
    from detxgnn.collectors.drug_bundle import DrugBundle
