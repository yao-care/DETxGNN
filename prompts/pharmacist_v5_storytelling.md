...
- `taiwan_regulatory`: BfArM approval and market status in Germany
...
| Germany Market Status | [Extract from taiwan_regulatory.market_status] |
...
| Evidence Level | L1 |
| Germany Market Status | ✓ Marketed |
...
In fact, the S-1 combination has been approved in Japan and Germany for colorectal cancer treatment,
